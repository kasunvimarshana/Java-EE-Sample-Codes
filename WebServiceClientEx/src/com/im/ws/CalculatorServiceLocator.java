...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.im.ws.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/WebServiceEx/services/Calculator";
    ...
    public com.im.ws.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.im.ws.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.im.ws.CalculatorSoapBindingStub _stub = new com.im.ws.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.im.ws.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.im.ws.CalculatorSoapBindingStub _stub = new com.im.ws.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.im.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.im.com", "Calculator"));
        }
